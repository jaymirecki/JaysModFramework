# Vector4.Maximize Method (Vector4, Vector4)

﻿Vector4.Maximize Method (Vector4, Vector4)

|  |  |  |
| --- | --- | --- |
| Vector4Maximize Method (Vector4, Vector4) | RAGE Plugin Hook Documentation |  |
...
```
Public Shared Function Maximize ( 
	value1 As Vector4,
	value2 As Vector4
) As Vector4
```
