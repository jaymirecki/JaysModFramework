...
|  |  |  |
| --- | --- | --- |
| Vector2UnitY Property | RAGE Plugin Hook Documentation |  |

[This is preliminary documentation and is subject to change.]

Gets the Y unit [Vector2](T_Rage_Vector2.htm) (0, 1).
...
A [Vector2](T_Rage_Vector2.htm) that has a value of (0, 1).
