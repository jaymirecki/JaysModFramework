# GameFiber.ExecuteNewWhile Method (ThreadStart, Func(Boolean))

﻿GameFiber.ExecuteNewWhile Method (ThreadStart, Func(Boolean))

|  |  |  |
| --- | --- | --- |
| GameFiberExecuteNewWhile Method (ThreadStart, FuncBoolean) | RAGE Plugin Hook Documentation |  |
...
:   Type: [SystemFunc](http://msdn2.microsoft.com/en-us/library/bb534960)[Boolean](http://msdn2.microsoft.com/en-us/library/a28wyd50)  
    ...
    [Missing <param name="condition"/> documentation for "M:Rage.GameFiber.ExecuteNewWhile(System.Threading.ThreadStart,System.Func{System.Boolean})"]
