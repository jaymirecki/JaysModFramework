...
|  |  |  |
| --- | --- | --- |
| Object Class | RAGE Plugin Hook Documentation |  |
...
```
[SerializableAttribute]
public ref class Object : public Entity
```
...
|  | Name | Description |
| --- | --- | --- |
| Protected method | [Object(PoolHandle)](M_Rage_Object__ctor_2.htm) | Initializes a new instance of the Object class. |
| Public method | [Object(Model, Vector3)](M_Rage_Object__ctor.htm) | Initializes a new instance of the Object class. |
| Public method | [Object(Model, Vector3, Single)](M_Rage_Object__ctor_1.htm) | Initializes a new instance of the Object class. |
...
| Public property | [HasBeenDamagedByAnyObject](P_Rage_Entity_HasBeenDamagedByAnyObject.htm) | Gets or sets a value indicating whether this entity has been damaged by any Object. (Inherited from [Entity](T_Rage_Entity.htm).) |
