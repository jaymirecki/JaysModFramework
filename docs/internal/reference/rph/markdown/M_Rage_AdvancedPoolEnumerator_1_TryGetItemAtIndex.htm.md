# AdvancedPoolEnumerator(HT).TryGetItemAtIndex Method

﻿AdvancedPoolEnumerator(HT).TryGetItemAtIndex Method 

|  |  |  |
| --- | --- | --- |
| AdvancedPoolEnumeratorHTTryGetItemAtIndex Method | RAGE Plugin Hook Documentation |  |
...
```
Protected Overrides Function TryGetItemAtIndex ( 
	index As Integer
) As ULong
```
...
```
protected:
virtual unsigned long long TryGetItemAtIndex(
	int index
) override
```
...
Type: [UInt64](http://msdn2.microsoft.com/en-us/library/06cf7918)  
