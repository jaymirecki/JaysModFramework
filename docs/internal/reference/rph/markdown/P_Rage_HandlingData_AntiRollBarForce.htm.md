# HandlingData.AntiRollBarForce Property

﻿HandlingData.AntiRollBarForce Property 

|  |  |  |
| --- | --- | --- |
| HandlingDataAntiRollBarForce Property | RAGE Plugin Hook Documentation |  |
...
```
Public Property AntiRollBarForce As Single
	Get
	Set
```
...
```
public:
property float AntiRollBarForce {
	float get ();
