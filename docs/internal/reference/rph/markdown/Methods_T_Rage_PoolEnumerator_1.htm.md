# PoolEnumerator(HT) Methods

﻿PoolEnumerator(HT) Methods

|  |  |  |
| --- | --- | --- |
| PoolEnumeratorHT Methods | RAGE Plugin Hook Documentation |  |

[This is preliminary documentation and is subject to change.]

The [PoolEnumeratorHT](T_Rage_PoolEnumerator_1.htm) generic type exposes the following members.

Methods

|  | Name | Description |
| --- | --- | --- |
| Public method | [Dispose](M_Rage_PoolEnumerator_1_Dispose.htm) |  |
| Protected method | [Dispose(Boolean)](M_Rage_PoolEnumerator_1_Dispose_1.htm) |  |
