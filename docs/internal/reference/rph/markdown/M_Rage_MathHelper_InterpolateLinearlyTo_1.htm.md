# MathHelper.InterpolateLinearlyTo Method (Vector2, Vector2, Single, Single)

﻿MathHelper.InterpolateLinearlyTo Method (Vector2, Vector2, Single, Single)

|  |  |  |
| --- | --- | --- |
| MathHelperInterpolateLinearlyTo Method (Vector2, Vector2, Single, Single) | RAGE Plugin Hook Documentation |  |
...
```
public:
static Vector2 InterpolateLinearlyTo(
	Vector2 current, 
	Vector2 target, 
	float deltaTime, 
	float speed
