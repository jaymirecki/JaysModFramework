# Vehicle.IsEngineStarting Property

﻿Vehicle.IsEngineStarting Property 

|  |  |  |
| --- | --- | --- |
| VehicleIsEngineStarting Property | RAGE Plugin Hook Documentation |  |
...
```
Public Property IsEngineStarting As Boolean
	Get
	Set
```
...
```
public:
property bool IsEngineStarting {
	bool get ();
	void set (bool value);
}
```
