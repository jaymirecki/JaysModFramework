# Vehicle Constructor (Model, Vector3, Single)

﻿Vehicle Constructor (Model, Vector3, Single)

|  |  |  |
| --- | --- | --- |
| Vehicle Constructor (Model, Vector3, Single) | RAGE Plugin Hook Documentation |  |
...
model
:   Type: [RageModel](T_Rage_Model.htm)  
    The model to use.
