# AnimationTask.Length Property

﻿AnimationTask.Length Property 

|  |  |  |
| --- | --- | --- |
| AnimationTaskLength Property | RAGE Plugin Hook Documentation |  |
...
The length of the animation represented by this task, in seconds.
