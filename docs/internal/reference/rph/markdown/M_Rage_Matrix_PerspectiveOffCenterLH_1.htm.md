# Matrix.PerspectiveOffCenterLH Method (Single, Single, Single, Single, Single, Single, Matrix)

﻿Matrix.PerspectiveOffCenterLH Method (Single, Single, Single, Single, Single, Single, Matrix)

|  |  |  |
| --- | --- | --- |
| MatrixPerspectiveOffCenterLH Method (Single, Single, Single, Single, Single, Single, Matrix) | RAGE Plugin Hook Documentation |  |
...
```
Public Shared Sub PerspectiveOffCenterLH ( 
	left As Single,
	right As Single,
	bottom As Single,
	top As Single,
...
```
public:
static void PerspectiveOffCenterLH(
	float left, 
	float right, 
	float bottom, 
	float top, 
