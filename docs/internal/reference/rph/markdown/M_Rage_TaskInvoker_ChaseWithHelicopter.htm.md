# TaskInvoker.ChaseWithHelicopter Method

﻿TaskInvoker.ChaseWithHelicopter Method 

|  |  |  |
| --- | --- | --- |
| TaskInvokerChaseWithHelicopter Method | RAGE Plugin Hook Documentation |  |
...
```
Public Function ChaseWithHelicopter ( 
	target As Ped,
	offset As Vector3
) As Task
```
