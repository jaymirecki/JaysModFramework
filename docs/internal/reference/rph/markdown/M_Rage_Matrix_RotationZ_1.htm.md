# Matrix.RotationZ Method (Single, Matrix)

﻿Matrix.RotationZ Method (Single, Matrix)

|  |  |  |
| --- | --- | --- |
| MatrixRotationZ Method (Single, Matrix) | RAGE Plugin Hook Documentation |  |
