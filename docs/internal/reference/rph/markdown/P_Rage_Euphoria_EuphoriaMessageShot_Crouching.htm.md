# EuphoriaMessageShot.Crouching Property

﻿EuphoriaMessageShot.Crouching Property 

|  |  |  |
| --- | --- | --- |
| EuphoriaMessageShotCrouching Property | RAGE Plugin Hook Documentation |  |
...
```
<EuphoriaParameterAttribute("crouching", Type := GetType(Boolean), 
	DefaultValue := false)>
...
```
public:
[EuphoriaParameterAttribute(L"crouching", Type = typeof(bool), DefaultValue = false)]
