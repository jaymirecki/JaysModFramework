# Vehicle.GetFreePassengerSeatIndex Method

﻿Vehicle.GetFreePassengerSeatIndex Method 

|  |  |  |
| --- | --- | --- |
| VehicleGetFreePassengerSeatIndex Method | RAGE Plugin Hook Documentation |  |
...
```
Public Function GetFreePassengerSeatIndex As Nullable(Of Integer)
```

```
public:
Nullable<int> GetFreePassengerSeatIndex()
```
