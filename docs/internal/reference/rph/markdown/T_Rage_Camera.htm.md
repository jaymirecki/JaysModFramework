...
|  |  |  |
| --- | --- | --- |
| Camera Class | RAGE Plugin Hook Documentation |  |

[This is preliminary documentation and is subject to change.]

[Missing <summary> documentation for "T:Rage.Camera"]
...
```
[SerializableAttribute]
public ref class Camera sealed : public Entity
```
...
|  | Name | Description |
| --- | --- | --- |
| Public method | [Camera(Boolean)](M_Rage_Camera__ctor.htm) | Initializes a new instance of the Camera class |
| Public method | [Camera(String, Boolean)](M_Rage_Camera__ctor_1.htm) | Initializes a new instance of the Camera class |
...
| Public property | [Active](P_Rage_Camera_Active.htm) | Gets or sets a value indicating whether this instance is currently active. |
...
| Public property | [FOV](P_Rage_Camera_FOV.htm) |  |
...
| Public property | [IsPersistent](P_Rage_Camera_IsPersistent.htm) | Gets or sets a value indicating whether this instance is persistent within the game world. Persistent instances will not be removed automatically during clean ups. (Overrides [EntityIsPersistent](P_Rage_Entity_IsPersistent.htm).) |
...
| Public property | [IsRendering](P_Rage_Camera_IsRendering.htm) | Gets a value indicating whether this instance is the gameplay camera. |
...
| Public property | [MemoryAddress](P_Rage_Camera_MemoryAddress.htm) | Gets the memory address of this instance. (Overrides [EntityMemoryAddress](P_Rage_Entity_MemoryAddress.htm).) |
...
| Public property | [Position](P_Rage_Camera_Position.htm) | Gets or sets the position of this instance. (Overrides [EntityPosition](P_Rage_Entity_Position.htm).) |
| Public property | [Quaternion](P_Rage_Camera_Quaternion.htm) | Gets or sets the quaternion of this instance. (Overrides [EntityQuaternion](P_Rage_Entity_Quaternion.htm).) |
...
| Public propertyStatic member | [RenderingCamera](P_Rage_Camera_RenderingCamera.htm) | Gets the camera currently being rendered. |
...
| Public property | [Rotation](P_Rage_Camera_Rotation.htm) | Gets or sets the rotation of this instance. (Overrides [EntityRotation](P_Rage_Entity_Rotation.htm).) |
...
| Public method | [AttachToEntity](M_Rage_Camera_AttachToEntity.htm) | Gets or sets the state of this instance. |
| Public method | [Delete](M_Rage_Camera_Delete.htm) | Deletes this instance.  Any call to a non-existent instance is invalid and will cause an exception. (Overrides [EntityDelete](M_Rage_Entity_Delete.htm).) |
| Public methodStatic member | [DeleteAllCameras](M_Rage_Camera_DeleteAllCameras.htm) |  |
...
| Public method | [Dismiss](M_Rage_Camera_Dismiss.htm) | If this instance is marked as persistent, makes the entity non-persistent. Non-persistent entities will be deleted from the game world during clean ups.  This is equivalent to setting IsPersistent to false. (Overrides [EntityDismiss](M_Rage_Entity_Dismiss.htm).) |
...
| Public method | [IsValid](M_Rage_Camera_IsValid.htm) | Determines whether this instance still represents an existing entity within the game world. Calls to an invalid instance is illegal and will result in an exception. (Overrides [EntityIsValid](M_Rage_Entity_IsValid.htm).) |
...
| Public method | [PointAtEntity](M_Rage_Camera_PointAtEntity.htm) | Points this instance at the specified [Entity](T_Rage_Entity.htm) at the specified offset. |
...
| Public method | [Shake(Single)](M_Rage_Camera_Shake.htm) | Shakes this instance for the specified duration. |
| Public method | [Shake(String, Single)](M_Rage_Camera_Shake_1.htm) | Shakes this instance with the specified shake type, for the specified duration. |
