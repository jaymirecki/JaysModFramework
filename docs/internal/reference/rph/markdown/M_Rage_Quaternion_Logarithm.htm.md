# Quaternion.Logarithm Method (Quaternion)

﻿Quaternion.Logarithm Method (Quaternion)

|  |  |  |
| --- | --- | --- |
| QuaternionLogarithm Method (Quaternion) | RAGE Plugin Hook Documentation |  |
...
```
public static Quaternion Logarithm(
	Quaternion quaternion
)
```

```
Public Shared Function Logarithm ( 
