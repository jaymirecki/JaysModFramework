# Game.LogVeryVerbose Method

﻿Game.LogVeryVerbose Method 

|  |  |  |
| --- | --- | --- |
| GameLogVeryVerbose Method | RAGE Plugin Hook Documentation |  |
...
```
public static void LogVeryVerbose(
	string text
)
```

```
Public Shared Sub LogVeryVerbose ( 
	text As String
)
```
