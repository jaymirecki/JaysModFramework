# AdvancedPoolEnumerator(HT) Properties

﻿AdvancedPoolEnumerator(HT) Properties

|  |  |  |
| --- | --- | --- |
| AdvancedPoolEnumeratorHT Properties | RAGE Plugin Hook Documentation |  |

[This is preliminary documentation and is subject to change.]

The [AdvancedPoolEnumeratorHT](T_Rage_AdvancedPoolEnumerator_1.htm) generic type exposes the following members.
