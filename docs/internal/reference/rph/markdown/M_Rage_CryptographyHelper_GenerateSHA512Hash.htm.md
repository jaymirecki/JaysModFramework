# CryptographyHelper.GenerateSHA512Hash Method (Stream)

﻿CryptographyHelper.GenerateSHA512Hash Method (Stream)

|  |  |  |
| --- | --- | --- |
| CryptographyHelperGenerateSHA512Hash Method (Stream) | RAGE Plugin Hook Documentation |  |
...
Returns the 128 byte checksum of the data in the specified stream.
