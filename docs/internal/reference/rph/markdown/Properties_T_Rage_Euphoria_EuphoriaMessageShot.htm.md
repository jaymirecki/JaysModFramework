...
|  |  |  |
| --- | --- | --- |
| EuphoriaMessageShot Properties | RAGE Plugin Hook Documentation |  |

[This is preliminary documentation and is subject to change.]

The [EuphoriaMessageShot](T_Rage_Euphoria_EuphoriaMessageShot.htm) type exposes the following members.
