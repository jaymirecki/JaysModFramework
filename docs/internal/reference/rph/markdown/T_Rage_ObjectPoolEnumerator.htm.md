...
|  |  |  |
| --- | --- | --- |
| ObjectPoolEnumerator Class | RAGE Plugin Hook Documentation |  |
...
  [RagePoolEnumerator](T_Rage_PoolEnumerator_1.htm)[Object](T_Rage_Object.htm)  
    [RageSimplePoolEnumerator](T_Rage_SimplePoolEnumerator_1.htm)[Object](T_Rage_Object.htm)  
...
```
Public Class ObjectPoolEnumerator
	Inherits SimplePoolEnumerator(Of Object)
```

```
public ref class ObjectPoolEnumerator : public SimplePoolEnumerator<Object^>
```
...
|  | Name | Description |
| --- | --- | --- |
| Public method | [ObjectPoolEnumerator](M_Rage_ObjectPoolEnumerator__ctor.htm) | Initializes a new instance of the ObjectPoolEnumerator class |
...
| Protected method | [GetHandleableByAddress](M_Rage_ObjectPoolEnumerator_GetHandleableByAddress.htm) | (Overrides [PoolEnumeratorHTGetHandleableByAddress(UInt64)](M_Rage_PoolEnumerator_1_GetHandleableByAddress.htm).) |
...
| Protected method | [IsItemValid](M_Rage_ObjectPoolEnumerator_IsItemValid.htm) | (Overrides [PoolEnumeratorHTIsItemValid(UInt64)](M_Rage_PoolEnumerator_1_IsItemValid.htm).) |
