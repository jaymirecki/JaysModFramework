...
|  |  |  |
| --- | --- | --- |
| Building Properties | RAGE Plugin Hook Documentation |  |

[This is preliminary documentation and is subject to change.]

The [Building](T_Rage_Building.htm) type exposes the following members.
...
[Building Class](T_Rage_Building.htm)
