...
|  |  |  |
| --- | --- | --- |
| IHashedAsset Interface | RAGE Plugin Hook Documentation |  |
...
```
Public Interface IHashedAsset
	Inherits IAsset
```

```
public interface class IHashedAsset : IAsset
```
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [Hash](P_Rage_IHashedAsset_Hash.htm) | Gets the hash of this asset. |
