# Vehicle.AccelerationScale Property

﻿Vehicle.AccelerationScale Property 

|  |  |  |
| --- | --- | --- |
| VehicleAccelerationScale Property | RAGE Plugin Hook Documentation |  |
...
```
Public ReadOnly Property AccelerationScale As Single
	Get
```
