# Vehicle.AreAllComponentsBroken Method

﻿Vehicle.AreAllComponentsBroken Method 

|  |  |  |
| --- | --- | --- |
| VehicleAreAllComponentsBroken Method | RAGE Plugin Hook Documentation |  |
...
```
Public Function AreAllComponentsBroken ( 
	components As VehicleComponents
) As Boolean
```

```
public:
bool AreAllComponentsBroken(
	VehicleComponents components
)
```
...
components
:   Type: [RageVehicleComponents](T_Rage_VehicleComponents.htm)  
