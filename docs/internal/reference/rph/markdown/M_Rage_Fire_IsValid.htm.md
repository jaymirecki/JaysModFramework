...
|  |  |  |
| --- | --- | --- |
| FireIsValid Method | RAGE Plugin Hook Documentation |  |
...
If this instance still represents an existing fire within the game world, returns true; otherwise, returns false.
