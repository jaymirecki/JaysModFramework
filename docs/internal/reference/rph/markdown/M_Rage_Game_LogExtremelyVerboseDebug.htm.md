# Game.LogExtremelyVerboseDebug Method

﻿Game.LogExtremelyVerboseDebug Method 

|  |  |  |
| --- | --- | --- |
| GameLogExtremelyVerboseDebug Method | RAGE Plugin Hook Documentation |  |
...
public static void LogExtremelyVerboseDebug(
	string text
)
```
...
```
<ConditionalAttribute("DEBUG")>
Public Shared Sub LogExtremelyVerboseDebug ( 
	text As String
)
```
...
static void LogExtremelyVerboseDebug(
	String^ text
)
```
