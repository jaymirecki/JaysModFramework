# Entity.GetOffsetPositionUp Method

﻿Entity.GetOffsetPositionUp Method 

|  |  |  |
| --- | --- | --- |
| EntityGetOffsetPositionUp Method | RAGE Plugin Hook Documentation |  |
...
```
Public Function GetOffsetPositionUp ( 
	offset As Single
) As Vector3
```
