...
|  |  |  |
| --- | --- | --- |
| Weapon Class | RAGE Plugin Hook Documentation |  |

[This is preliminary documentation and is subject to change.]

[Missing <summary> documentation for "T:Rage.Weapon"]
...
public sealed class Weapon : Object
```
...
```
[SerializableAttribute]
public ref class Weapon sealed : public Object
```
...
|  | Name | Description |
| --- | --- | --- |
| Public method | [Weapon](M_Rage_Weapon__ctor.htm) | Initializes a new instance of the Weapon class. |
...
| Public property | [Ammo](P_Rage_Weapon_Ammo.htm) | Gets or sets the amount of ammo this instance has left. |
| Public property | [AmmoInClip](P_Rage_Weapon_AmmoInClip.htm) | Gets or sets the amount of ammo in the current clip of this instance. |
...
| Public property | [Asset](P_Rage_Weapon_Asset.htm) |  |
...
| Public property | [State](P_Rage_Weapon_State.htm) |  |
...
| Public method | [GiveTo](M_Rage_Weapon_GiveTo.htm) |  |
