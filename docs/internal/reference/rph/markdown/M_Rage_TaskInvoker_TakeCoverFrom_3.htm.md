# TaskInvoker.TakeCoverFrom Method (Vector3, Int32, Boolean)

﻿TaskInvoker.TakeCoverFrom Method (Vector3, Int32, Boolean)

|  |  |  |
| --- | --- | --- |
| TaskInvokerTakeCoverFrom Method (Vector3, Int32, Boolean) | RAGE Plugin Hook Documentation |  |
...
```
Public Function TakeCoverFrom ( 
	position As Vector3,
	duration As Integer,
	shootAtTarget As Boolean
) As Task
```
...
[TakeCoverFrom Overload](Overload_Rage_TaskInvoker_TakeCoverFrom.htm)
