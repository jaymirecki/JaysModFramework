# Vector4.CatmullRom Method (Vector4, Vector4, Vector4, Vector4, Single)

﻿Vector4.CatmullRom Method (Vector4, Vector4, Vector4, Vector4, Single)

|  |  |  |
| --- | --- | --- |
| Vector4CatmullRom Method (Vector4, Vector4, Vector4, Vector4, Single) | RAGE Plugin Hook Documentation |  |
