# TaskInvoker.AchieveHeading Method (Single, Int32)

﻿TaskInvoker.AchieveHeading Method (Single, Int32)

|  |  |  |
| --- | --- | --- |
| TaskInvokerAchieveHeading Method (Single, Int32) | RAGE Plugin Hook Documentation |  |
...
```
Public Function AchieveHeading ( 
	heading As Single,
	timeout As Integer
) As Task
```
...
[AchieveHeading Overload](Overload_Rage_TaskInvoker_AchieveHeading.htm)
