# Matrix.PerspectiveFovLH Method (Single, Single, Single, Single, Matrix)

﻿Matrix.PerspectiveFovLH Method (Single, Single, Single, Single, Matrix)

|  |  |  |
| --- | --- | --- |
| MatrixPerspectiveFovLH Method (Single, Single, Single, Single, Matrix) | RAGE Plugin Hook Documentation |  |
...
```
Public Shared Sub PerspectiveFovLH ( 
	fov As Single,
	aspect As Single,
	znear As Single,
	zfar As Single,
