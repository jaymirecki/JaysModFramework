# Vector2.Minimize Method (Vector2, Vector2)

﻿Vector2.Minimize Method (Vector2, Vector2)

|  |  |  |
| --- | --- | --- |
| Vector2Minimize Method (Vector2, Vector2) | RAGE Plugin Hook Documentation |  |
...
```
public static Vector2 Minimize(
	Vector2 value1,
	Vector2 value2
)
```
