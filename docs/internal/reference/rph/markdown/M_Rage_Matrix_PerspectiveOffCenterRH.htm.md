# Matrix.PerspectiveOffCenterRH Method (Single, Single, Single, Single, Single, Single)

﻿Matrix.PerspectiveOffCenterRH Method (Single, Single, Single, Single, Single, Single)

|  |  |  |
| --- | --- | --- |
| MatrixPerspectiveOffCenterRH Method (Single, Single, Single, Single, Single, Single) | RAGE Plugin Hook Documentation |  |
