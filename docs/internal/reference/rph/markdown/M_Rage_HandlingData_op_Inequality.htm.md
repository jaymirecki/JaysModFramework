# HandlingData.Inequality Operator

﻿HandlingData.Inequality Operator 

|  |  |  |
| --- | --- | --- |
| HandlingDataInequality Operator | RAGE Plugin Hook Documentation |  |

[This is preliminary documentation and is subject to change.]

Determines whether the the first [HandlingData](T_Rage_HandlingData.htm) instance represents a different handling data than the second [HandlingData](T_Rage_HandlingData.htm) instance.
