# Camera.IsPersistent Property

﻿Camera.IsPersistent Property 

|  |  |  |
| --- | --- | --- |
| CameraIsPersistent Property | RAGE Plugin Hook Documentation |  |
...
```
Public Overrides Property IsPersistent As Boolean
	Get
	Set
```
...
[Missing <value> documentation for "P:Rage.Camera.IsPersistent"]

#### Implements

[IPersistableIsPersistent](P_Rage_IPersistable_IsPersistent.htm)  
