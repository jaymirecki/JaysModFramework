# Vector3.Barycentric Method (Vector3, Vector3, Vector3, Single, Single)

﻿Vector3.Barycentric Method (Vector3, Vector3, Vector3, Single, Single)

|  |  |  |
| --- | --- | --- |
| Vector3Barycentric Method (Vector3, Vector3, Vector3, Single, Single) | RAGE Plugin Hook Documentation |  |
...
A new [Vector3](T_Rage_Vector3.htm) containing the 3D Cartesian coordinates of the specified point.
