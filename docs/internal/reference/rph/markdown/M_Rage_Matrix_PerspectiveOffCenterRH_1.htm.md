# Matrix.PerspectiveOffCenterRH Method (Single, Single, Single, Single, Single, Single, Matrix)

﻿Matrix.PerspectiveOffCenterRH Method (Single, Single, Single, Single, Single, Single, Matrix)

|  |  |  |
| --- | --- | --- |
| MatrixPerspectiveOffCenterRH Method (Single, Single, Single, Single, Single, Single, Matrix) | RAGE Plugin Hook Documentation |  |
...
```
Public Shared Sub PerspectiveOffCenterRH ( 
	left As Single,
	right As Single,
	bottom As Single,
	top As Single,
...
```
public:
static void PerspectiveOffCenterRH(
	float left, 
	float right, 
	float bottom, 
	float top, 
...
[PerspectiveOffCenterRH Overload](Overload_Rage_Matrix_PerspectiveOffCenterRH.htm)
