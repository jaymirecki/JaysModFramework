# Vector3.Add Method (Vector3, Vector3, Vector3)

﻿Vector3.Add Method (Vector3, Vector3, Vector3)

|  |  |  |
| --- | --- | --- |
| Vector3Add Method (Vector3, Vector3, Vector3) | RAGE Plugin Hook Documentation |  |
...
[Add Overload](Overload_Rage_Vector3_Add.htm)
