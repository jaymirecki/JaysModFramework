# HandlingData.AntiRollBarBiasFront Property

﻿HandlingData.AntiRollBarBiasFront Property 

|  |  |  |
| --- | --- | --- |
| HandlingDataAntiRollBarBiasFront Property | RAGE Plugin Hook Documentation |  |
...
```
Public Property AntiRollBarBiasFront As Single
	Get
	Set
```
...
```
public:
property float AntiRollBarBiasFront {
	float get ();
