# Matrix.OrthoLH Method (Single, Single, Single, Single, Matrix)

﻿Matrix.OrthoLH Method (Single, Single, Single, Single, Matrix)

|  |  |  |
| --- | --- | --- |
| MatrixOrthoLH Method (Single, Single, Single, Single, Matrix) | RAGE Plugin Hook Documentation |  |
