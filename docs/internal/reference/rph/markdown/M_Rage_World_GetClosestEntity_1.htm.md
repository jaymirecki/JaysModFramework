# World.GetClosestEntity Method (Vector3, Single, GetEntitiesFlags)

﻿World.GetClosestEntity Method (Vector3, Single, GetEntitiesFlags)

|  |  |  |
| --- | --- | --- |
| WorldGetClosestEntity Method (Vector3, Single, GetEntitiesFlags) | RAGE Plugin Hook Documentation |  |
...
flags
:   Type: [RageGetEntitiesFlags](T_Rage_GetEntitiesFlags.htm)  
...
[Missing <returns> documentation for "M:Rage.World.GetClosestEntity(Rage.Vector3,System.Single,Rage.GetEntitiesFlags)"]
