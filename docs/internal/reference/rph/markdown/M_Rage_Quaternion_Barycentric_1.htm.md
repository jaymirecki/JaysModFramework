# Quaternion.Barycentric Method (Quaternion, Quaternion, Quaternion, Single, Single, Quaternion)

﻿Quaternion.Barycentric Method (Quaternion, Quaternion, Quaternion, Single, Single, Quaternion)

|  |  |  |
| --- | --- | --- |
| QuaternionBarycentric Method (Quaternion, Quaternion, Quaternion, Single, Single, Quaternion) | RAGE Plugin Hook Documentation |  |
...
result
:   Type: [RageQuaternion](T_Rage_Quaternion.htm)  
    When the method completes, contains a new [Quaternion](T_Rage_Quaternion.htm) containing the 4D Cartesian coordinates of the specified point.
