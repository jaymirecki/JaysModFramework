# RelationshipGroup.Inequality Operator

﻿RelationshipGroup.Inequality Operator 

|  |  |  |
| --- | --- | --- |
| RelationshipGroupInequality Operator | RAGE Plugin Hook Documentation |  |

[This is preliminary documentation and is subject to change.]

Determines whether the the first [RelationshipGroup](T_Rage_RelationshipGroup.htm) instance represents a different blip than the second [RelationshipGroup](T_Rage_RelationshipGroup.htm) instance.
