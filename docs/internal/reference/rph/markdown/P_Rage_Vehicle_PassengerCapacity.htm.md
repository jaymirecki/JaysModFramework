# Vehicle.PassengerCapacity Property

﻿Vehicle.PassengerCapacity Property 

|  |  |  |
| --- | --- | --- |
| VehiclePassengerCapacity Property | RAGE Plugin Hook Documentation |  |
...
```
Public ReadOnly Property PassengerCapacity As Integer
	Get
```

```
public:
property int PassengerCapacity {
	int get ();
}
```
