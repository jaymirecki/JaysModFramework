# Vector3.TransformCoordinate Method (Vector3*, Int32, Matrix*, Vector3*, Int32, Int32)

﻿Vector3.TransformCoordinate Method (Vector3\*, Int32, Matrix\*, Vector3\*, Int32, Int32)

|  |  |  |
| --- | --- | --- |
| Vector3TransformCoordinate Method (Vector3, Int32, Matrix, Vector3, Int32, Int32) | RAGE Plugin Hook Documentation |  |
