# World.TraceExtent Method (Vector3, Vector3, Single, TraceFlags, Entity[])

﻿World.TraceExtent Method (Vector3, Vector3, Single, TraceFlags, Entity[])

|  |  |  |
| --- | --- | --- |
| WorldTraceExtent Method (Vector3, Vector3, Single, TraceFlags, Entity) | RAGE Plugin Hook Documentation |  |
