# Matrix.OrthoOffCenterLH Method (Single, Single, Single, Single, Single, Single, Matrix)

﻿Matrix.OrthoOffCenterLH Method (Single, Single, Single, Single, Single, Single, Matrix)

|  |  |  |
| --- | --- | --- |
| MatrixOrthoOffCenterLH Method (Single, Single, Single, Single, Single, Single, Matrix) | RAGE Plugin Hook Documentation |  |
...
```
Public Shared Sub OrthoOffCenterLH ( 
	left As Single,
	right As Single,
	bottom As Single,
	top As Single,
...
[OrthoOffCenterLH Overload](Overload_Rage_Matrix_OrthoOffCenterLH.htm)
