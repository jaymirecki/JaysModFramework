# GameControl Enumeration

﻿GameControl Enumeration

|  |  |  |
| --- | --- | --- |
| GameControl Enumeration | RAGE Plugin Hook Documentation |  |

[This is preliminary documentation and is subject to change.]

[Missing <summary> documentation for "T:Rage.GameControl"]
...
```
Public Enumeration GameControl
```

```
public enum class GameControl
```
...
|  | LookLeftOnly | 5 |  |
|  | LookRightOnly | 6 |  |
|  | CinematicSlowMotion | 7 |  |
|  | ScriptedFlyUpDown | 8 |  |
|  | ScriptedFlyLeftRight | 9 |  |
|  | ScriptedFlyZUp | 10 |  |
|  | ScriptedFlyZDown | 11 |  |
