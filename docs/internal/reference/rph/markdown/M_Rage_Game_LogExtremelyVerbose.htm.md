# Game.LogExtremelyVerbose Method

﻿Game.LogExtremelyVerbose Method 

|  |  |  |
| --- | --- | --- |
| GameLogExtremelyVerbose Method | RAGE Plugin Hook Documentation |  |
...
```
public static void LogExtremelyVerbose(
	string text
)
```

```
Public Shared Sub LogExtremelyVerbose ( 
	text As String
)
```
...
```
public:
static void LogExtremelyVerbose(
	String^ text
)
```
