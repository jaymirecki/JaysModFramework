# EuphoriaMessageShot.AllowInjuredArm Property

﻿EuphoriaMessageShot.AllowInjuredArm Property 

|  |  |  |
| --- | --- | --- |
| EuphoriaMessageShotAllowInjuredArm Property | RAGE Plugin Hook Documentation |  |
...
```
<EuphoriaParameterAttribute("allowInjuredArm", Type := GetType(Boolean), 
	DefaultValue := false)>
Public Property AllowInjuredArm As Boolean
	Get
	Set
```
...
```
public:
[EuphoriaParameterAttribute(L"allowInjuredArm", Type = typeof(bool), 
	DefaultValue = false)]
