# PedPoolEnumerator Properties

﻿PedPoolEnumerator Properties

|  |  |  |
| --- | --- | --- |
| PedPoolEnumerator Properties | RAGE Plugin Hook Documentation |  |

[This is preliminary documentation and is subject to change.]

The [PedPoolEnumerator](T_Rage_PedPoolEnumerator.htm) type exposes the following members.
