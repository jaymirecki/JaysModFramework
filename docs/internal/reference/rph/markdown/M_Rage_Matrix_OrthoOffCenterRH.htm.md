# Matrix.OrthoOffCenterRH Method (Single, Single, Single, Single, Single, Single)

﻿Matrix.OrthoOffCenterRH Method (Single, Single, Single, Single, Single, Single)

|  |  |  |
| --- | --- | --- |
| MatrixOrthoOffCenterRH Method (Single, Single, Single, Single, Single, Single) | RAGE Plugin Hook Documentation |  |
...
```
Public Shared Function OrthoOffCenterRH ( 
	left As Single,
	right As Single,
	bottom As Single,
	top As Single,
