# Graphics.DrawTexture Method (Texture, Vector2, Vector2, Single, Single, Single, Single, Single)

﻿Graphics.DrawTexture Method (Texture, Vector2, Vector2, Single, Single, Single, Single, Single)

|  |  |  |
| --- | --- | --- |
| GraphicsDrawTexture Method (Texture, Vector2, Vector2, Single, Single, Single, Single, Single) | RAGE Plugin Hook Documentation |  |
