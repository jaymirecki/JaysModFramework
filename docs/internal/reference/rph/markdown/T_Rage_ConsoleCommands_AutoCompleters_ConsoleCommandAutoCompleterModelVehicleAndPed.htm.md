# ConsoleCommandAutoCompleterModelVehicleAndPed Class

﻿ConsoleCommandAutoCompleterModelVehicleAndPed Class

|  |  |  |
| --- | --- | --- |
| ConsoleCommandAutoCompleterModelVehicleAndPed Class | RAGE Plugin Hook Documentation |  |

[This is preliminary documentation and is subject to change.]

[Missing <summary> documentation for "T:Rage.ConsoleCommands.AutoCompleters.ConsoleCommandAutoCompleterModelVehicleAndPed"]
...
          Rage.ConsoleCommands.AutoCompletersConsoleCommandAutoCompleterModelVehicleAndPed  
**Namespace:**
...
public sealed class ConsoleCommandAutoCompleterModelVehicleAndPed : ConsoleCommandAutoCompleterModel
```

```
<SerializableAttribute>
<ConsoleCommandParameterAutoCompleterAttribute(New Type() { ... })>
Public NotInheritable Class ConsoleCommandAutoCompleterModelVehicleAndPed
	Inherits ConsoleCommandAutoCompleterModel
```

```
[SerializableAttribute]
[ConsoleCommandParameterAutoCompleterAttribute(__gc new array<Type^>^ { ... })]
public ref class ConsoleCommandAutoCompleterModelVehicleAndPed sealed : public ConsoleCommandAutoCompleterModel
```

The ConsoleCommandAutoCompleterModelVehicleAndPed type exposes the following members.

Constructors

|  | Name | Description |
| --- | --- | --- |
| Public method | [ConsoleCommandAutoCompleterModelVehicleAndPed](M_Rage_ConsoleCommands_AutoCompleters_ConsoleCommandAutoCompleterModelVehicleAndPed__ctor.htm) | Initializes a new instance of the ConsoleCommandAutoCompleterModelVehicleAndPed class |
...
| Public method | [UpdateOptions](M_Rage_ConsoleCommands_AutoCompleters_ConsoleCommandAutoCompleterModel_UpdateOptions.htm) | (Inherited from [ConsoleCommandAutoCompleterModel](T_Rage_ConsoleCommands_AutoCompleters_ConsoleCommandAutoCompleterModel.htm).) |
