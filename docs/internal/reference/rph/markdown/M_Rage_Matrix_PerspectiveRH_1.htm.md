# Matrix.PerspectiveRH Method (Single, Single, Single, Single, Matrix)

﻿Matrix.PerspectiveRH Method (Single, Single, Single, Single, Matrix)

|  |  |  |
| --- | --- | --- |
| MatrixPerspectiveRH Method (Single, Single, Single, Single, Matrix) | RAGE Plugin Hook Documentation |  |
...
```
Public Shared Sub PerspectiveRH ( 
	width As Single,
	height As Single,
	znear As Single,
	zfar As Single,
