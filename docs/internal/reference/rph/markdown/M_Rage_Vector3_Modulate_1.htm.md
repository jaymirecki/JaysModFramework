# Vector3.Modulate Method (Vector3, Vector3, Vector3)

﻿Vector3.Modulate Method (Vector3, Vector3, Vector3)

|  |  |  |
| --- | --- | --- |
| Vector3Modulate Method (Vector3, Vector3, Vector3) | RAGE Plugin Hook Documentation |  |
...
[Modulate Overload](Overload_Rage_Vector3_Modulate.htm)
