# KeyboardLayoutCustom.ParseSpecialKey Method

﻿KeyboardLayoutCustom.ParseSpecialKey Method 

|  |  |  |
| --- | --- | --- |
| KeyboardLayoutCustomParseSpecialKey Method | RAGE Plugin Hook Documentation |  |
...
```
Public Overridable Function ParseSpecialKey ( 
	key As Keys,
	shift As Boolean,
	ctrl As Boolean,
	alt As Boolean
...
```
public:
virtual String^ ParseSpecialKey(
	Keys key, 
	bool shift, 
	bool ctrl, 
	bool alt
...
[IKeyboardLayoutParseSpecialKey(Keys, Boolean, Boolean, Boolean)](M_Rage_IKeyboardLayout_ParseSpecialKey.htm)  

See Also

#### Reference

[KeyboardLayoutCustom Class](T_Rage_KeyboardLayoutCustom.htm)
