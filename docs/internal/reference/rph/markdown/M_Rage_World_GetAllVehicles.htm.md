# World.GetAllVehicles Method

﻿World.GetAllVehicles Method 

|  |  |  |
| --- | --- | --- |
| WorldGetAllVehicles Method | RAGE Plugin Hook Documentation |  |

[This is preliminary documentation and is subject to change.]

Gets all [Vehicle](T_Rage_Vehicle.htm)s currently in the game world.
...
```
Public Shared Function GetAllVehicles As Vehicle()
```
...
An array of all [Vehicle](T_Rage_Vehicle.htm)s currently in the game world.
