# CryptographyHelper.GenerateSHA256Hash Method (String, Encoding)

﻿CryptographyHelper.GenerateSHA256Hash Method (String, Encoding)

|  |  |  |
| --- | --- | --- |
| CryptographyHelperGenerateSHA256Hash Method (String, Encoding) | RAGE Plugin Hook Documentation |  |
...
Returns the 64 byte checksum of the specified text.
