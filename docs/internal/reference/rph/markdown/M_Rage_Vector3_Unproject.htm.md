# Vector3.Unproject Method (Vector3, Single, Single, Single, Single, Single, Single, Matrix)

﻿Vector3.Unproject Method (Vector3, Single, Single, Single, Single, Single, Single, Matrix)

|  |  |  |
| --- | --- | --- |
| Vector3Unproject Method (Vector3, Single, Single, Single, Single, Single, Single, Matrix) | RAGE Plugin Hook Documentation |  |
