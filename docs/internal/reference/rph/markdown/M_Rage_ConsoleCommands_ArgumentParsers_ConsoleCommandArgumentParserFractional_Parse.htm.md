# ConsoleCommandArgumentParserFractional.Parse Method

﻿ConsoleCommandArgumentParserFractional.Parse Method 

|  |  |  |
| --- | --- | --- |
| ConsoleCommandArgumentParserFractionalParse Method | RAGE Plugin Hook Documentation |  |
...
If successful, returns the resulting [Single](http://msdn2.microsoft.com/en-us/library/3www918f); otherwise, returns null.

See Also

#### Reference

[ConsoleCommandArgumentParserFractional Class](T_Rage_ConsoleCommands_ArgumentParsers_ConsoleCommandArgumentParserFractional.htm)
