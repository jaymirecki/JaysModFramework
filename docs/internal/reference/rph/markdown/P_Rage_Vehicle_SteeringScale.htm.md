# Vehicle.SteeringScale Property

﻿Vehicle.SteeringScale Property 

|  |  |  |
| --- | --- | --- |
| VehicleSteeringScale Property | RAGE Plugin Hook Documentation |  |
...
A [Single](http://msdn2.microsoft.com/en-us/library/3www918f) between -1.0f (fully right) and 1.0f (fully left).
