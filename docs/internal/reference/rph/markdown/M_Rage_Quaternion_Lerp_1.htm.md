# Quaternion.Lerp Method (Quaternion, Quaternion, Single, Quaternion)

﻿Quaternion.Lerp Method (Quaternion, Quaternion, Single, Quaternion)

|  |  |  |
| --- | --- | --- |
| QuaternionLerp Method (Quaternion, Quaternion, Single, Quaternion) | RAGE Plugin Hook Documentation |  |
