# ObjectPoolEnumerator Methods

﻿ObjectPoolEnumerator Methods

|  |  |  |
| --- | --- | --- |
| ObjectPoolEnumerator Methods | RAGE Plugin Hook Documentation |  |

[This is preliminary documentation and is subject to change.]

The [ObjectPoolEnumerator](T_Rage_ObjectPoolEnumerator.htm) type exposes the following members.
