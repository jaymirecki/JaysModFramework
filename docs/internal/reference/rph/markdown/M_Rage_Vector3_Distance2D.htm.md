# Vector3.Distance2D Method (Vector3, ISpatial)

﻿Vector3.Distance2D Method (Vector3, ISpatial)

|  |  |  |
| --- | --- | --- |
| Vector3Distance2D Method (Vector3, ISpatial) | RAGE Plugin Hook Documentation |  |
...
```
Public Shared Function Distance2D ( 
	value1 As Vector3,
...
[Distance2D Overload](Overload_Rage_Vector3_Distance2D.htm)
