# Quaternion.Invert Method (Quaternion, Quaternion)

﻿Quaternion.Invert Method (Quaternion, Quaternion)

|  |  |  |
| --- | --- | --- |
| QuaternionInvert Method (Quaternion, Quaternion) | RAGE Plugin Hook Documentation |  |
...
[Invert Overload](Overload_Rage_Quaternion_Invert.htm)
