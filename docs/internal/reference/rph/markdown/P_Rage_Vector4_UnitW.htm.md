...
|  |  |  |
| --- | --- | --- |
| Vector4UnitW Property | RAGE Plugin Hook Documentation |  |

[This is preliminary documentation and is subject to change.]

Gets the W unit [Vector4](T_Rage_Vector4.htm) (0, 0, 0, 1).
...
A [Vector4](T_Rage_Vector4.htm) that has a value of (0, 0, 0, 1).
